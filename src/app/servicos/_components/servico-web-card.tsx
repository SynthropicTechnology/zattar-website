...
export function ServicoWebCard({
  ...
  return (
    ...
    >
      ...
      <span className="relative z-10 inline-flex items-center gap-2 py-2 text-primary font-headline font-bold text-sm tracking-tight group-hover:gap-4 transition-all">
        {cta}
